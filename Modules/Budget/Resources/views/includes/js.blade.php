<script>
    ...
    function updateDetailValue(tag, type, group){
        ...
        Swal.fire({
            ...
            html: `
                <input style="max-width: 300px; border: 1px solid #ccc !important; text-align: center;" type="text" id="swal-input-text" class="swal2-input" placeholder="Descrição">
                <input style="max-width: 300px; border: 1px solid #ccc !important; text-align: center;" type="number" id="swal-input-number" class="swal2-input" placeholder="Novo valor">`,
