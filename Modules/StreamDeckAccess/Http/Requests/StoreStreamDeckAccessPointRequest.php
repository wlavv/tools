...
class StoreStreamDeckAccessPointRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => [
                ...
                Rule::unique('streamdeck_access_points', 'slug'),
            ],
            'description' => ['nullable', 'string', 'max:5000'],
            'type' => ['required', Rule::in(array_keys(config('streamdeck-access.types', [])))],
