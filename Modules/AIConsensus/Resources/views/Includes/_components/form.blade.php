<form method="POST" action="{{ $action }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="ai-card">
                <a href="{{ route('ai_consensus.index') }}" class="btn btn-outline-primary"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
                <button type="submit" class="btn btn-outline-success" style="float: right;"><i class="fa fa-cogs" aria-hidden="true"></i></button>
            </div>
        </div>
