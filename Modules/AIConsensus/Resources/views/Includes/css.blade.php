...
@media (max-width:991px){.ai-dashboard-grid,.ai-stats,.ai-grid,.ai-counters{grid-template-columns:1fr}.ai-grid-1{grid-column:span 1}}
@media (max-width:768px){.ai-consensus-page{padding:.75rem}.ai-page-header,.ai-card,.ai-form-card,.ai-toolbar{padding:.9rem}.ai-page-header__main{flex-direction:column}.ai-page-header__identity{width:100%}.lsg-page-actions{width:100%;justify-content:flex-start}.ai-table-wrap,.ai-consensus-page .table-responsive{display:none}}
</style>
