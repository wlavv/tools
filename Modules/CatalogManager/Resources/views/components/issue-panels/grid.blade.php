...
<div class="catalog-lsg-card">
    <div style="display:flex;justify-content:space-between;gap:1rem;align-items:center;margin-bottom:.85rem;">
        <div>
            ...
            <h3 style="margin:0;">Problemas operacionais</h3>
        </div>

        <a href="{{ route('catalog-manager.issue-panels.index') }}" class="btn btn-outline-primary btn-sm">
    ...
    <div class="catalog-lsg-panel-grid">
        @foreach($panels as $panel)
            @include('catalogmanager::components.issue-panels.panel', ['panel' => $panel])
        @endforeach
    </div>
</div>
