...
@section('catalogmanager-content')
    <div class="catalog-lsg-hero">
        <div>
            ...
            <h1>Novo Atributo de Combinação</h1>
        </div>
    </div>

    <div class="catalog-lsg-card">
        <form method="POST" action="{{ route('catalog-manager.combination-attributes.store') }}">
            @csrf
            @include('catalogmanager::combination_attributes._form')
