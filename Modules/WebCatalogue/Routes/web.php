...
use Modules\WebCatalogue\Http\Controllers\Recognition\RecognitionBenchmarkController;
...
Route::middleware(config('webcatalogue.middleware', ['web', 'auth']))
    ...
    ->group(function () {
        ...
        Route::prefix('recognition')->name('recognition.')->group(function () {
            ...
            Route::post('/sessions/{session}/benchmark', [RecognitionBenchmarkController::class, 'runSession'])->name('sessions.benchmark');
