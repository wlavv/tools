...
return [
    ...
    'recognition' => [
        ...
        'pipeline_v2' => [
            ...
            'weights' => [
                'phash' => (float) env('WEBCATALOGUE_RECOGNITION_V2_WEIGHT_PHASH', 0.32),
                'ahash_dhash' => (float) env('WEBCATALOGUE_RECOGNITION_V2_WEIGHT_AHASH_DHASH', 0.18),
                ...
                'color' => (float) env('WEBCATALOGUE_RECOGNITION_V2_WEIGHT_COLOR', 0.12),
            ],
            'decision' => [
