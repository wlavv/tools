...
<div class="wc-editor-layout">
    <div>
        <div class="wc-detail-hero wc-detail-hero-theme">
            <div>
                <span class="wc-eyebrow"><i class="fa-solid fa-palette"></i> Theme</span>
                <h2>{{ $item->name ?? $item->title ?? $item->reference ?? 'Theme' }}</h2>
            ...
            <div class="wc-detail-icon"><i class="fa-solid fa-palette"></i></div>
        </div>
        ...
        <div class="wc-detail-grid">
            ...
            <div class="wc-info-card"><i class="fa-solid fa-circle-info"></i><span>Font Family</span><strong>{{ $item->font_family ?? '—' }}</strong></div>
            <div class="wc-info-card"><i class="fa-solid fa-circle-info"></i><span>Primary Color</span><strong>{{ $item->primary_color ?? '—' }}</strong></div>
            <div class="wc-info-card"><i class="fa-solid fa-circle-info"></i><span>Accent Color</span><strong>{{ $item->accent_color ?? '—' }}</strong></div>
    ...
    <aside class="wc-preview-panel">
        ...
        <div class="wc-preview-card">
            <div class="wc-preview-media"><i class="fa-solid fa-palette wc-preview-icon"></i></div>
            <div class="wc-preview-body"><h4>Theme preview</h4><p class="wc-muted">Visual summary of this record.</p></div>
        </div>
        <div class="wc-preview-card"><div class="wc-preview-body"><h4>Actions</h4><div class="wc-actions-row"><a class="wc-action-link" href="{{ route('webcatalogue.themes.edit', $item) }}"><i class="fa-solid fa-pencil"></i> Edit</a><a class="wc-action-link" href="{{ route('webcatalogue.themes.index') }}"><i class="fa-solid fa-angle-left"></i> Back</a></div></div></div>
    </aside>
</div>
</div>
@endsection
