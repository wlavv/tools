...
<div class="wc-editor-layout">
    ...
    <aside class="wc-preview-panel">
        ...
        <div class="wc-preview-card"><div class="wc-preview-body"><h4>Actions</h4><div class="wc-actions-row"><a class="wc-action-link" href="{{ route('webcatalogue.promotions.edit', $item) }}"><i class="fa-solid fa-pencil"></i> Edit</a><a class="wc-action-link" href="{{ route('webcatalogue.promotions.index') }}"><i class="fa-solid fa-angle-left"></i> Back</a></div></div></div>
    </aside>
</div>
</div>
@endsection
