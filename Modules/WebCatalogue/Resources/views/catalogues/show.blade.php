...
<div class="wc-editor-layout">
    <div>
        <div class="wc-detail-hero wc-detail-hero-catalogue">
            <div>
                <span class="wc-eyebrow"><i class="fa-solid fa-book-open"></i> Catalogue</span>
                <h2>{{ $item->name ?? $item->title ?? $item->reference ?? 'Catalogue' }}</h2>
            ...
            <div class="wc-detail-icon"><i class="fa-solid fa-book-open"></i></div>
        </div>
        ...
        <div class="wc-detail-grid">
            ...
            <div class="wc-info-card"><i class="fa-solid fa-circle-info"></i><span>Catalogue Type</span><strong>{{ $item->catalogue_type ?? '—' }}</strong></div>
            <div class="wc-info-card"><i class="fa-solid fa-circle-info"></i><span>Visibility</span><strong>{{ $item->visibility ?? '—' }}</strong></div>
            <div class="wc-info-card"><i class="fa-solid fa-circle-info"></i><span>Price Mode</span><strong>{{ $item->price_mode ?? '—' }}</strong></div>
    ...
    <aside class="wc-preview-panel">
        ...
        <div class="wc-preview-card">
            <div class="wc-preview-media"><i class="fa-solid fa-book-open wc-preview-icon"></i></div>
            <div class="wc-preview-body"><h4>Catalogue preview</h4><p class="wc-muted">Visual summary of this record.</p></div>
        </div>
        <div class="wc-preview-card"><div class="wc-preview-body"><h4>Actions</h4><div class="wc-actions-row"><a class="wc-action-link" href="{{ route('webcatalogue.catalogues.edit', $item) }}"><i class="fa-solid fa-pencil"></i> Edit</a><a class="wc-action-link" href="{{ route('webcatalogue.catalogues.index') }}"><i class="fa-solid fa-angle-left"></i> Back</a></div></div></div>
    </aside>
</div>
</div>
@endsection
