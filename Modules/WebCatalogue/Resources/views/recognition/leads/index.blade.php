    ...
    <div class="wc-rich-list">
        @forelse($items as $item)
            <div class="wc-rich-card">
                ...
                <div class="wc-rich-actions"><a class="wc-action-link btn-outline-primary" href="{{ route('webcatalogue.recognition.leads.show', $item) }}"><i class="fa-solid fa-eye"></i> View</a></div>
            </div>
        @empty
