        ...
        <div class="wc-immersive">
            ...
            <aside class="wc-immersive-panel">
                ...
                <div class="wc-immersive-actions">
                    ...
                    <span class="wc-btn wc-btn-disabled"><i class="fa-solid fa-shield-halved"></i> Protected 3D asset</span>
                </div>
                @if($images->count())
    ...
    @else
        <div class="wc-no-model">
            <div class="wc-card wc-panel">
                ...
                <p class="wc-richtext">This product does not have a generated or uploaded GLB resource yet.</p>
