    ...
    <div class="panel_parent">
        <div class="panel">
            ...
            <div style="margin: 20px;width: calc(100% - 40px);">
                <div style="width: 32%; float: left;text-align: center; font-size: 26px; background-color: #FFF; color: #333;border: 1px solid #FFF;padding: 10px 0;"><i class="fa-solid fa-image"></i></div>
                <div style="width: 32%; float: left;text-align: center; font-size: 26px; background-color: transparent; color: #fff;border: 1px solid #FFF;padding: 10px 0;"><i class="fa-solid fa-euro-sign"></i></div>
                <div style="width: 32%; float: right;text-align: center; font-size: 26px; background-color: transparent; color: #fff;border: 1px solid #FFF;padding: 10px 0;"><i class="fa-solid fa-ban"></i></div>
            </div>
        </div>
    </div>
    <div class="panel_parent">
