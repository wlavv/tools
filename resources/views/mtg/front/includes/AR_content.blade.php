<div id="multi-panel" class="panel-container cardContainer">
    ...
    <div class="panel_parent">
        ...
        <div class="panel">
            ...
            <div>
                <svg onclick="window.open('https://www.youtube.com/results?search_query=Akroma%2C+Angel+of+Wrath', '_blank')" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve" focusable="false" aria-hidden="true" style="pointer-events: none; display: inherit; width: 100%; height: 100%;">
                    <g>
