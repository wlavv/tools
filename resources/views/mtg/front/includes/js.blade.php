<script>
        // 1. Captura do vídeo e configuração do canvas
        ...
        // 3. Função para converter a imagem para tons de cinza
        ...
        // 5. Método para aplicar a detecção de bordas (filtro de Sobel ou Canny)
        ...
        window.onload = function() {
            ...
            function render() {
                ...
                var imageData = trackingContext.getImageData(0, 0, canvas.width, canvas.height);

                // Converte a imagem para tons de cinza
                var grayscaleData = convertToGrayscale(imageData);

                // Desenha no canvas de preview
                previewCanvas.width = video.videoWidth; // Ajusta o tamanho do canvas conforme o vídeo
