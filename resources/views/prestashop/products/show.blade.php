...
@section('content')
    <div class="navbar navbar-light customPanel">
        ...
        <div class="row">
            ...
            <div class="col-lg-10"><label class="showInfo">{{$supplier->name}}</label></div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-10"><label class="showInfo">@if($supplier->active == 1) <span class="text-green">{{ __('messages.yes')}}</span> @else <span class="text-red">{{ __('messages.no')}}</span> @endif</label></div>
        </div>
    </div>
